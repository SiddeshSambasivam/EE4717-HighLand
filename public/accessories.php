...
<head>
    ...
    <title>HighLand - Accessories</title>
        ...
        <div class="products">
            ...
            <div class="listings-container" id="products-list">                            
                <?php
                    ...
                    include("../src/db_connect.php");    
                    $sql = "SELECT * FROM `products` WHERE `category` = 'accessory' LIMIT ".$this_page_first_result.",".$results_per_page;
                    $result = $conn->query($sql);
                    $conn->close();
                            ...
                            $products .= '
                                <div class="product__card">
                                    ...
                                    <div class="product__info">
                                        <a class="add_cart__btn" onclick="handleAddCart(\''.$row["title"].'\','.$row['price'].',1,\''.$row["product_id"].'\',\''.preg_split("/\,/", $row['size'])[0].'\',\''.preg_split("/\,/", $row['color'])[0].'\'); callSnacker()">
