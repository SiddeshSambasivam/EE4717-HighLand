...
INSERT INTO products (title, price, description, image, items_in_stock, rating, category, color, size, tags) VALUES 
    ...
    ("Graphic T-Shirt",19.99,"Embrace your youthful self with this graphic tee.","../assets/product_5.jpg",100 ,3.9 ,"top","S,M,L","blue","men"),
    ...
    ("Graphic T-Shirt",19.99,"Embrace your youthful self with this graphic tee.","../assets/product_9.jpg",100 ,3.9 ,"top","S,M,L","black","men"),
    ...
    ("Graphic Hoodie",49.90,"Stay warm and fashionable with this hoodie made with premium 100% Merino Wool sourced from the highest grade Merino sheeps","../assets/product_12.jpg", 60,4.1 ,"top","green","S,M,L","men"),
    ...
    ("Graphic T-Shirt",19.99,"Embrace your youthful self with this graphic tee.","../assets/product_21.jpg",100 ,3.8 ,"top","S,M,L","red,black","women"),
    ...
    ("Graphic T-Shirt",19.99,"Embrace your youthful self with this graphic tee.","../assets/product_24.jpg",100 ,3.5 ,"top","S,M,L","white","women"),
    ("Graphic Shirt",19.99,"Embrace your youthful self with this shirt.","../assets/product_25.jpg",100 ,3.4 ,"top","S,M,L","pink,black","men"),
